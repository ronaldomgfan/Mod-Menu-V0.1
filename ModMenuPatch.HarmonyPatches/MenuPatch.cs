...
internal class MenuPatch
{
    ...
    colorr.color = Color.black;
            ...
            GameObject.Find("Level/lower level/UI/CodeOfConduct").GetComponent<Text>().text = "[<color=yellow>Hacked Menu Paid News:</color>]";
            GameObject.Find("Level/lower level/UI/Tree Room Texts/COC Text").GetComponent<Text>().text = "My First Menu! Thanks For Buying";
        }
